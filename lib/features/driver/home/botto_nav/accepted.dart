            ...
            Expanded(child: GetBuilder<DriverController>(
              builder: (controller) {
               controller.addacceptcordenate();
                ...
                return controller.acceptedvalues.isEmpty? const Center(child: CircularProgressIndicator(),):ListView.builder(
                  itemCount: controller.acceptedvalues.length,
                  itemBuilder: (context, index) {
                    
                    log(controller.accpetRetailData.toString(),name: 'ui');
                    return Padding(
                            ...
                            children: [
                              SizedBox(
                                  ...
                                  child: Image.network(
                                    controller.dataList[0][controller
                                        .acceptedvalues[index]['pname']]['pic'],
                                  )
                              ...
                              Column(
                                children: [
                                  ...
                                  GestureDetector(onTap: () =>    Get.to(NavigationScreen(controller.accpetcordination[index].latitude,controller.accpetcordination[index].longitude)),
                                    child: const Row(
                                      children: [
                              ...
                              GestureDetector(
                                onTap: () {
                                  controller.deleverstatusUpdate(
                                      ...
                                      controller.acceptedvalues[index]['pname'],
                                      'de',
