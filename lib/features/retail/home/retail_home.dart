              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(onTap: () => _openDrawer(context),child: const Icon(Icons.menu)),
                      const Center(child: Text('Retail')),
                      const Text('')
                    ],
                  ),
                ),
                          ...
                          child: GridView.count(
                            ...
                            children: List.generate(
                                controller.dataList[0].length, (index) {
                                  log(controller.dataList[0].values.toList()[0]['pic']);
                                      ...
                                      return AlertDialog(
                                        content: Column(
                                          ...
                                          children: [
                                                  ...
                                                  child: Column(
                                                    crossAxisAlignment:
                                                        CrossAxisAlignment
                                                            .stretch,
                                                    children: [
                                                      Image.network(controller.dataList[0].values.toList()[index]['pic'],
                                            ...
                                            Text(
                                              controller.dataList[0].keys.toList()[index],
                                            ...
                                            Padding(
                                              padding:
                                                  const EdgeInsets.symmetric(
                                                      horizontal: 16),
                                              child: Text(controller.dataList[0].values.toList()[index]['details'],
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                homeContro.placeOrder(controller.dataList[0].keys.toList()[index]);
                                                 QuickAlert.show(
                              context: context,
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                               controller.dataList[0].values.toList()[index]['details'],maxLines: 2,overflow: TextOverflow.ellipsis,
                                                style: const TextStyle(
                                                  fontSize: 14.0,
                                                  color: Colors.grey,
                                                ),
